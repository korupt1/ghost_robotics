...
StructuredBuffer<float3> TexCoords;
...
vs2ps VS(VS_IN input)
{
	...
	float4 Force = ForceField_Texture.SampleLevel(volumeSampler, TexCoords[input.iv],1);
	
    Out.PosWVP = float4(WorldPos[input.iv],1);
